...
function SuccessContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center" data-testid="checkout-success-page-container">
        <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
          <CheckCircle className="w-10 h-10 text-green-600" />
        </div>

        <h1 className="text-3xl font-bold text-gray-900 mb-2" data-testid="checkout-success-title">Payment Successful!</h1>
